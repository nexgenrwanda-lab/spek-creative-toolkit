            ...
            {tools.map((tool) => (
              <Card key={tool.id} className="group hover:shadow-hover transition-all duration-300 hover:-translate-y-2 border-0 shadow-tool">
                <CardContent className="p-8">
                  <div className="p-4 rounded-2xl w-fit mb-6 group-hover:scale-110 transition-transform duration-300">
                    {tool.id === 'palette' ? (
                      <img src="/lovable-uploads/19345d9e-16c9-43f6-a0b2-0f512ca29982.png" alt="Spek Palette" className="h-16 object-contain" />
                    ) : (
                      tool.icon
                    )}
                  </div>
